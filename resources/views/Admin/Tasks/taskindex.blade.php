...
<div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.tasks.search') }}" method="GET" class="mb-3">
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <label for="location">Search</label>
                                <input type="text" class="form-control border border-2 p-2" name="query" placeholder="Search by title or description" value="{{ request('query') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="location" class="d-block">&nbsp;</label>
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                @foreach ($tasks as $task)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="{{ route('admin.tasks.permanent-delete', $task->id) }}" method="POST" class="d-inline">
                                                                    @csrf
                                                                    @method('DELETE')
